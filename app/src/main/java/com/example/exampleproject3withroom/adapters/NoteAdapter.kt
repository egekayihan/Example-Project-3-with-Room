package com.example.exampleproject3withroom.adapters
...
import com.example.exampleproject3withroom.view.MainActivity
import com.example.exampleproject3withroom.view.UpdateActivity
...
class NoteAdapter(private val activity : MainActivity) : RecyclerView.Adapter<NoteAdapter.NoteViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NoteViewHolder, position: Int) {
        ...
        holder.cardView.setOnClickListener {
            ...
            intent.putExtra("currentDesc", currentNote.desc)
    ...
    fun getNote(pos : Int) : Note{ return notes[pos] }
