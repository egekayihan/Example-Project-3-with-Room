...
import com.example.exampleproject3withroom.NoteApplication
import com.example.exampleproject3withroom.R
import com.example.exampleproject3withroom.adapters.NoteAdapter
import com.example.exampleproject3withroom.model.Note
import com.example.exampleproject3withroom.viewModel.NoteViewModel
import com.example.exampleproject3withroom.viewModel.NoteViewModelFactory
...
class MainActivity : AppCompatActivity() {
        ...
        updateActivityResultLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult(),
            ActivityResultCallback { resultUpdateNote ->
                ...
                if(resultCode == RESULT_OK && data != null){
                    ...
                    val updatedDesc : String = data.getStringExtra("updatedDesc").toString()
    ...
    fun showDialogMessage(){
        ...
        dialogMessage.setMessage("If click Yes all notes will delete, if you want to " +
                "delete a specific note, please swipe left or right")
